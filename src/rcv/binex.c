...
{
    RTKtrace(2,"binex 0x00-15: not supported message\n");
    return 0;
}
...
{
    RTKtrace(2,"binex 0x00-7f: not supported message\n");
    return 0;
}
...
{
    RTKtrace(2,"binex 0x01-00: not supported message\n");
    return 0;
}
